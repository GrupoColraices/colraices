  ...
  return (
    <section className="w-full bg-[#FBF8F3] pt-[70px] sm:pt-[85px] lg:pt-[99.98px] pb-[75px] sm:pb-[90px] lg:pb-[100px]">
      <div className="w-full max-w-[1375.37px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-[155.69px] flex flex-col gap-[40px] sm:gap-[48px] lg:gap-[51.98px]">
        ...
        {/* CARDS */}
        <div className="w-full max-w-[1063.99px] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-[24px] lg:gap-[28px] items-stretch">
          {/* CARD 1 */}
          <div className="w-full h-full rounded-[28px] sm:rounded-[32px] overflow-hidden bg-white border border-[#0F2D5C]/10 shadow-[0_14px_38px_rgba(15,45,92,0.10)] hover:-translate-y-[8px] hover:shadow-[0_24px_55px_rgba(15,45,92,0.16)] transition-all duration-500 ease-out flex flex-col">
            {/* TOP */}
            <div className="relative w-full min-h-[210px] sm:min-h-[230px] rounded-t-[28px] sm:rounded-t-[32px] overflow-hidden bg-gradient-to-r from-[#091D3E] to-[#FFC107] shrink-0">
              ...
              <div className="relative z-10 px-6 sm:px-8 pt-8 sm:pt-9">
                <div className="flex justify-between items-start mb-3 gap-4 flex-wrap">
                  <span
                    aria-hidden="true"
                    className="text-[30px] sm:text-[32px] leading-none"
                  >
                    🗺️
                  </span>

                  <span className="min-h-[25px] px-4 sm:px-[18px] rounded-full border border-[#0F2D5C]/35 bg-[#F0B429]/20 flex items-center text-[#0F2D5C] text-[9px] sm:text-[9.92px] font-bold uppercase tracking-[0.99px] hover:bg-[#F0B429]/30 transition-all duration-300 whitespace-nowrap">
                    Más completo
                  </span>
                </div>
            ...
            {/* BOTTOM */}
            <div className="px-6 sm:px-8 pt-7 pb-8 bg-white border-t border-[#0F2D5C]/10 flex flex-col flex-1">
              ...
              <div className="mt-auto border-t border-[#94A3B8]/30 pt-5 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-5">
                <div>
          ...
          <div className="w-full h-full rounded-[28px] sm:rounded-[32px] overflow-hidden bg-white border border-[#0F2D5C]/10 shadow-[0_14px_38px_rgba(15,45,92,0.10)] hover:-translate-y-[8px] hover:shadow-[0_24px_55px_rgba(15,45,92,0.16)] transition-all duration-500 ease-out flex flex-col">
            {/* TOP */}
            <div className="relative w-full min-h-[210px] sm:min-h-[230px] rounded-t-[28px] sm:rounded-t-[32px] overflow-hidden bg-gradient-to-r from-[#2A3A5C] to-[#1A4F9E] shrink-0">
              <div className="absolute inset-0 opacity-[0.18] bg-[linear-gradient(rgba(255,255,255,0.16)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.16)_1px,transparent_1px)] bg-[size:19px_19px]" />
              ...
              <div className="relative z-10 px-6 sm:px-8 pt-8 sm:pt-9">
                <div className="flex justify-between items-start mb-3 gap-4 flex-wrap">
                  ...
                  <span className="min-h-[25px] px-4 sm:px-[18px] rounded-full border border-white/20 bg-white/[0.12] flex items-center text-white/70 text-[9px] sm:text-[9.92px] font-bold uppercase tracking-[0.99px] hover:bg-white/[0.20] transition-all duration-300 whitespace-nowrap">
                    Proceso estancado
                  </span>
                </div>
