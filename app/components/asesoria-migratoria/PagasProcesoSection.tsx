...
export default function PagasProcesoSection() {
  return (
    <section className="w-full bg-[#091D3E] pt-[100px] pb-[120px] px-[108px]">
      <div className="max-w-[1160px] mx-auto flex flex-col gap-[52px]">
        {/* HEADER */}
        ...
        <div className="w-full flex gap-[40px]">
          {/* LEFT MAIN CARD */}
          <div
            className="w-[512px] rounded-[32px] border relative"
            style={{
          ...
          >
            ...
            <div className="absolute top-[16px] right-[16px]">
              <div className="bg-[#FFC107] rounded-full px-[18px] py-[5px]">
                <span
            ...
            <div className="px-[41px] pt-[41px] pb-[41px]">
              {/* Subtitle */}
              <p
                className="uppercase text-white/40 mb-[28px]"
                style={{
                  fontFamily: "Montserrat, sans-serif",
                  fontSize: "10.88px",
                  fontWeight: 400,
              ...
              {/* Description */}
              <p
                className="text-white/45 mb-[40px]"
                style={{
                  fontFamily: "Montserrat, sans-serif",
                  fontSize: "12.8px",
                  fontWeight: 400,
              ...
              <div className="relative flex flex-col">
                ...
                {/* STEP 1 */}
                <div className="flex gap-[16px] mb-[36px] relative z-10">
                  ...
                  <div className="flex flex-col gap-[3px] pt-[2px]">
                    ...
                    <p
                      className="text-white/50 max-w-[377px]"
                      style={{
                        fontFamily: "Montserrat, sans-serif",
                        fontSize: "12px",
                        fontWeight: 400,
          ...
          {/* RIGHT SIDE */}
          <div className="w-[512px] flex flex-col gap-[16px]">
            {/* CARD 1 */}
            <div
              className="rounded-[20px] border px-[25px] py-[25px]"
              style={{
