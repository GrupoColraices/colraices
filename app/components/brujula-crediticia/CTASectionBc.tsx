      ...
      <div className="w-full max-w-[1180px] px-[48px] pt-[100px] pb-[60px] flex justify-center">
        ...
        <div className="w-full max-w-[720px] flex flex-col items-center text-center">
          ...
          <a
            ...
            className="mt-[28px] px-[28px] py-[10px] text-[14.4px] leading-[21.6px] font-semibold text-white border border-white/40 rounded-full hover:bg-white/[0.08] hover:border-white hover:text-white transition-all duration-300"
          >
