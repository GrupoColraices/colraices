...
export default function ProblemaSolucionSection() {
  return (
    <section className="w-full bg-[#FBF8F3] flex justify-center px-4 md:px-8 py-[80px] overflow-hidden">
      <div className="w-full max-w-[1180px] grid grid-cols-1 lg:grid-cols-[1fr_510px] gap-[48px] items-start">

        {/* LEFT SIDE */}
        <div className="flex flex-col gap-[24px] max-w-full">
          ...
          <p className="text-[14px] md:text-[15px] leading-[1.7] text-[#475569] max-w-[510px] w-full">
            La distancia hace que el historial financiero en Colombia
            quede en el olvido. Hasta que necesitas actuar sobre él.
          </p>

          <div className="flex flex-col gap-[12px] max-w-[510px] w-full">
        ...
        {/* RIGHT SIDE */}
        <div className="relative w-full lg:w-[510px] self-start">
