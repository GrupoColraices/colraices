    ...
    <section className="w-full flex justify-center bg-white">
      <div className="w-full max-w-[1180px] px-4 sm:px-8 py-14 md:py-[88px]">
        ...
        <div className="w-full max-w-[1084px]">
          ...
          <p className="mt-[8px] text-[14px] sm:text-[15.2px] leading-[24px] sm:leading-[25.8px] text-[#475569]">
        ...
        {/* GRID */}
        <div className="mt-10 md:mt-[48px] flex flex-col sm:flex-row gap-5 md:gap-[24px]">
 
          {/* CARD 1 */}
          <div className="
            w-full sm:w-1/2 md:w-[530px]
            bg-white border-[0.8px] border-[#0F2D5C]
            rounded-[16px_0px_16px_0px]
            flex flex-col
            px-[36.8px] pt-[36.8px] pb-8
          ...
          ">
            ...
            {/* Emoji */}
            <div className="mt-5 text-[32px] leading-[48px] text-[#0A0A0A]">🏠</div>
            ...
            <div
              ...
              style={{ borderTop: "0.8px solid rgba(15,45,92,0.1)", paddingTop: "20px" }}
            >
              <div className="flex justify-between gap-4">
                <span className="text-[13.12px] leading-[19.7px] text-[#94A3B8]">Financiación</span>
                <span className="text-[13.6px] leading-[20.4px] font-semibold text-[#0F2D5C] text-right">Hasta 80% del valor de la vivienda</span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-[13.12px] leading-[19.7px] text-[#94A3B8]">Plazo</span>
                <span className="text-[13.6px] leading-[20.4px] font-semibold text-[#0F2D5C] text-right">Hasta 30 años</span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-[13.12px] leading-[19.7px] text-[#94A3B8]">Cuota inicial</span>
                <span className="text-[13.6px] leading-[20.4px] font-semibold text-[#0F2D5C] text-right">Mínimo 20% del valor</span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-[13.12px] leading-[19.7px] text-[#94A3B8]">Tipo de vivienda</span>
                <span className="text-[13.6px] leading-[20.4px] font-semibold text-[#0F2D5C] text-right">Nueva o usada</span>
              </div>
            </div>
 
            {/* CTA */}
            <div className="mt-6 text-[14.4px] leading-[21.6px] font-semibold text-[#0A0A0A]">
          ...
          <div className="
            w-full sm:w-1/2 md:w-[530px]
            bg-white border-[0.8px] border-[rgba(15,45,92,0.1)]
            rounded-[16px_0px_16px_0px]
            flex flex-col
            px-[36.8px] pt-[36.8px] pb-8
            transition-all duration-[280ms] ease-[cubic-bezier(0.22,1,0.36,1)]
          ...
          ">
            ...
            >
              <div className="flex justify-between gap-4">
                <span className="text-[13.12px] leading-[19.7px] text-[#94A3B8]">Financiación</span>
                <span className="text-[13.6px] leading-[20.4px] font-semibold text-[#0F2D5C] text-right">Hasta 70% del valor del inmueble</span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-[13.12px] leading-[19.7px] text-[#94A3B8]">Plazo</span>
                <span className="text-[13.6px] leading-[20.4px] font-semibold text-[#0F2D5C] text-right">Hasta 15 años</span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-[13.12px] leading-[19.7px] text-[#94A3B8]">Garantía</span>
                <span className="text-[13.6px] leading-[20.4px] font-semibold text-[#0F2D5C] text-right">Hipoteca sobre inmueble</span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-[13.12px] leading-[19.7px] text-[#94A3B8]">Destino</span>
                <span className="text-[13.6px] leading-[20.4px] font-semibold text-[#0F2D5C] text-right">Libre (inversión, negocio, gastos)</span>
              </div>
            </div>
