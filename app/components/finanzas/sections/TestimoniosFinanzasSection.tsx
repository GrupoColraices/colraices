...
export default function TestimoniosFinanzasSection() {
  return (
    <section className="w-full bg-white pt-[88px] pb-[0px]">

      <div className="w-[1180px] mx-auto px-[48px]">
        ...
        <div className="flex gap-[20px]">
          ...
          {testimonios.map((item, i) => (
            ...
            >
              ...
              {/* DECOR NUMBER */}
              <span
                className="absolute text-[72px] font-bold opacity-[0.12]"
                style={{
                  color: item.color,
                  top: "2px",
                  left: "20.8px",
              ...
              <div className="mt-[6px]">
                <span
                  className="inline-flex px-[10px] py-[4px] rounded-full text-[10.4px] font-bold tracking-[0.83px]"
                  style={{
              ...
              {/* TEXT */}
              <p className="text-[#1E293B] text-[14.4px] italic leading-[25.2px] mt-[14px]">
                {item.quote}
              </p>
