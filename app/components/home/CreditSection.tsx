        ...
        <div className="relative z-20 mx-auto w-full max-w-[1180px] px-[20px] sm:px-[40px] md:px-[60px]">
          <div className="grid grid-cols-1 items-start gap-[40px] md:grid-cols-[1fr_359px] md:gap-[64px]">
            <div className="pt-[54px] md:pt-[58px]">
              <h2 className="mb-[28px] text-left md:mb-[30px]">
                <span className="block text-[26px] font-bold leading-[1.198] text-white sm:text-[30px] md:text-[31.2px]">
                  ¿Tienes ingresos en el exterior?
                </span>
                <span className="block text-[26px] font-normal leading-[1.198] text-white sm:text-[30px] md:whitespace-nowrap md:text-[28.29px]">
                  Puedes invertir y construir tu patrimonio en Colombia.
                </span>
                <span className="mt-[2px] block text-[24px] font-bold italic leading-[1.198] text-[#FFC107] sm:text-[28px] md:whitespace-nowrap md:text-[29.12px]">
                  Solo necesitas conocer tu cupo de crédito.
                </span>
              </h2>

              <div className="mb-[28px] max-w-[768.29px] space-y-[8px] text-[15.2px] font-normal leading-[26.6px] text-white/[0.55] md:mb-[30px]">
                <p>
                  Te ayudamos a calcular tu capacidad de financiamiento y validar
                  si hoy tu crédito es viable.
                </p>
            ...
            <div className="mx-auto w-full max-w-[359px] md:ml-auto">
              <div className="h-auto min-h-[466.07px] rounded-bl-none rounded-br-[16px] rounded-tl-[16px] rounded-tr-none bg-gradient-to-b from-[#F8F9FA] to-white p-[28px] shadow-[0_20px_50px_rgba(10,10,10,0.15)]">
                <div className="mx-auto mb-[20px] flex h-[35.97px] w-fit items-center justify-center gap-[8px] rounded-[20px] bg-[#FFC107] px-[15.99px] py-[6px] text-[#2A3F77]">
                  <span
                  ...
                  <span className="text-[12px] font-semibold leading-[19.5px]">
                    Tu cupo de crédito 100% online
                  </span>
                </div>
                ...
                <div className="mb-[30px] flex w-full max-w-[304.03px] flex-col gap-[22px]">
                  {[
                    ...
                    <div key={label} className="flex items-center gap-[13.98px]">
                      ...
                      <span className="text-[14px] font-semibold leading-[26.47px] text-[#2A3F77]">
                        {label}
                      </span>
                    </div>
                  ))}
