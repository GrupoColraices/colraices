        ...
        <div className="relative w-full max-w-[1180px] mx-auto px-[48px] pt-[80px] pb-[72px]">
          <div className="flex flex-col lg:flex-row justify-between gap-[64px]">
            ...
            <div className="w-full max-w-[640px] flex flex-col pt-[41px]">
              {/* TOP BADGE */}
              <div className="w-fit max-w-full rounded-full border border-[#FFC107]/30 bg-[#FFC107]/12 px-[14px] py-[8px] flex flex-col sm:flex-row sm:items-center gap-[6px] sm:gap-0">
                <div className="flex items-center">
                  <span className="text-[16px] leading-[24px] mr-[10px]">
                    💱
                  </span>
                ...
                <div className="sm:ml-[10px] rounded-full bg-[#FFC107] px-[12px] sm:px-[14px] py-[4px] flex items-center justify-center">
                  <span className="text-[#2A3F77] text-[11px] sm:text-[11.52px] font-bold leading-[17.3px] whitespace-nowrap">
