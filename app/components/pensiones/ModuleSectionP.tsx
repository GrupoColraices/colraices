...
export default function ModuleSectionP() {
  ...
  return (
    <section id="asesoria-planificacion-pensional" className="w-full min-h-[calc(100vh-80px)] scroll-mt-[50px] bg-[#FBF8F3] pt-[78px] pb-[96px] lg:pb-[120px] overflow-hidden">
