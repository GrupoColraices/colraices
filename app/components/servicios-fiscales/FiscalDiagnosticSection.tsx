  ...
  return (
    <>
      <section className="relative w-full bg-[#091D3E] py-16 lg:py-[88px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1180px] mx-auto px-5 sm:px-8 xl:px-[52px]">
          <div className="flex flex-col xl:flex-row items-start gap-10 xl:gap-14">
            ...
            {/* LEFT */}
            <div className="w-full xl:w-[510px] shrink-0">
              ...
              <div className="flex flex-col gap-[14px]">
                {leftCards.map((card, index) => (
                  <div
                    key={index}
                    className="group flex gap-[14px] p-5 rounded-[20px] bg-white/[0.04] border border-white/[0.08] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[8px_8px_24px_rgba(0,0,0,0.22)] hover:bg-white/[0.09] hover:border-white/[0.16] cursor-pointer"
                  >
                    <div className="w-9 h-9 min-w-[36px] rounded-md bg-[#059669]/[0.18] border border-[#10B981]/[0.25] flex items-center justify-center text-[15.2px] text-white transition-all duration-300 group-hover:bg-[#059669]/[0.28] group-hover:border-[#10B981]/[0.40] group-hover:scale-105">
                      {card.icon}
                    </div>
                    <div>
            ...
            {/* RIGHT CARD */}
            <div className="w-full xl:w-[510px] shrink-0 bg-white rounded-[32px] overflow-hidden">
              ...
              <div className="px-7 pb-7 mt-1.5">
                <button
                  ...
                  className="w-full h-[49.6px] rounded-full bg-[#0F2D5C] text-white text-[14.4px] font-semibold leading-[21.6px] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_22px_rgba(15,45,92,0.22)]"
                >
      ...
      <GeneralContactModal
        ...
        subtitle="con tu diagnóstico fiscal"
        source="servicios_fiscales_diagnostico"
